...
const Sidebar = ({
  ...
  onCollapsedChange,
    ...
    const navItems = [
        ...
        { href: "/assets", label: "Assets", icon: CirclePile },
    ...
    return (
        ...
        >
            ...
            {!isCollapsed && (
                ...
                <div className="w-8 h-8 bg-gradient-to-br from-accent to-brand rounded-lg flex items-center justify-center">
                    <div className="w-4 h-4 bg-gradient-to-br from-secondary/20 to-secondary/80 rounded-md"></div>
                </div>
                <span className="font-bold text-brand">ASMAT</span>
                </div>
            )}
            <div className="flex items-center gap-2">
                <Button
