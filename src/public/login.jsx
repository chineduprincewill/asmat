        ...
        <div className="min-h-screen flex items-center justify-center bg-background">
            <div className="w-full grid grid-cols-1 lg:grid-cols-2 min-h-screen">
                ...
                <div className="relative z-10 max-w-md text-center">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-accent to-brand rounded-2xl mb-8">
                        <div className="w-8 h-8 bg-gradient-to-br from-secondary/20 to-secondary/80 rounded-lg"></div>
                    </div>

                    <h2 className="text-4xl font-bold text-brand mb-4">ASMAT</h2>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-muted-foreground">Your account is protected with enterprise-grade security</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <p className="text-sm text-muted-foreground">Experience instant access to all features</p>
                        </div>
                    </div>
                ...
                <div className="w-full max-w-md">
                    ...
                    {/* Divider */}
                    <div className="hidden items-center gap-4 my-6">
